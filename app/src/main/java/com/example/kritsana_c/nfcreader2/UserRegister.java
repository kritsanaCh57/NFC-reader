...
//        Log.d(TAG, "resolveIntent start.");
        resolveIntent(getIntent());
//        Log.d(TAG, "resolveIntent done.");



        name = findViewById(R.id.editTextName);
        nfcTag = findViewById(R.id.editTextNFCTag);
        nfcTag.setText(getIntent().getStringExtra("NFC_TAG"));
        nfcTag.setEnabled(false);
        nfcTag.setClickable(false);

        //Log.d(TAG, "get string extra: "+ getIntent().getStringExtra("NFC_TAG"));
        ...
        button_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder.setTitle(getString(R.string.sure_submit_title));
                ...
                builder.setPositiveButton(getString(android.R.string.ok),
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                String name_tmp = name.getText().toString();
                                String nfcTag_tmp = nfcTag.getText().toString().replace(" ", "");
                                user.setName(name_tmp);
                                user.setTagId(nfcTag_tmp);
...
//        Log.d(TAG, "resolveIntent running.");

        String action = intent.getAction();
        Log.d(TAG, "resolveIntent: " + action);
    ...
    private void checkTagID (Tag tag){
        ...
        Log.d(TAG, id_hex);
        nfcTag = findViewById(R.id.editTextNFCTag);
        nfcTag.setText(id_hex.toString());
    }
